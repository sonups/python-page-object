...
from demoauto.locators.careers import CareersLocators as HP_Locators
from demoauto.pages import Page
from demoauto.pages.base import BasePage
from demoauto.map.urls import CareersPageUrl, Url
...
class CareersPage(Page):
    ...
    def __init__(self, browser: WebBrowser) -> None:
        ...
        self._page: Page = BasePage(browser, CareersPageUrl())
    ...
    def join_us(self) -> Element:
        return self.driver().find_element(self._by.xpath(), self._hp_locators.join_us)
